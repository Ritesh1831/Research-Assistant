...
class ResearchTools:
    def __init__(self):
        ...
        if not api_key:
            raise ValueError(
                "GOOGLE_API_KEY not found. Please create a .env file with your OpenAI API key:\n"
        ...
        self.llm = ChatGoogleGenerativeAI(
                    ...
                    temperature=0.1,
                    max_output_tokens=2000,   # equivalent to max_tokens
                    google_api_key=os.getenv("GOOGLE_API_KEY")  # load from .env
                    )
